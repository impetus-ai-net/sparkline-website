    ...
    <div className="mx-auto max-w-3xl">
      ...
      <Card className="mt-6 !p-0 overflow-hidden">
        <div className="border-b border-white/10 px-5 py-3 text-xs uppercase tracking-wider text-white/40">
          Top 10 recruiters
          {myRank != null && (
            <span className="ml-3 text-spark normal-case tracking-normal">
            ...
            <tbody>
              {leaderboard.map((r, i) => {
                ...
                return (
                  ...
                  >
                    <td className="px-5 py-3 tabular-nums text-white/55">
                      {i + 1}
                    </td>
                    <td className={`px-5 py-3 ${isMe ? "text-spark" : "text-white"}`}>
                      {displayName}
                    </td>
