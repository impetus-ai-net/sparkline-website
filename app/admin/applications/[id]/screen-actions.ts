...
${app.experience ?? "(blank)"}`;
  ...
  const res = await client.messages.create({
    ...
    system: [
      {
        type: "text",
        text: `You're screening high-school applicants for SparkLine, a 4-week startup accelerator. Be honest and direct — admins make the final decision, you're sorting the queue.
